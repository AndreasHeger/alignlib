...
class ImplLogOddor : public LogOddor 
{
 public:
    ...
    /** default constructor */
    ImplLogOddor  ( const Frequency * background_frequencies,  Score scale_factor = 1.0 );
 ...
 private:
    ...
    const Frequency * mBackgroundFrequencies;
    
    /** scale factor by which to divide the log-odds scores */
