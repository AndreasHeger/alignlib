...
Position ImplAlignataSet::getRowFrom() const { return (mPairs.size() > 0) ? (*mPairs.begin())->mRow : 0; }
Position ImplAlignataSet::getColFrom() const { return (mPairs.size() > 0) ? (*mPairs.begin())->mCol : 0; }
Position ImplAlignataSet::getRowTo()   const { return (mPairs.size() > 0) ? (*mPairs.rbegin())->mRow : 0; }
Position ImplAlignataSet::getColTo()   const { return (mPairs.size() > 0) ? (*mPairs.rbegin())->mCol : 0; }
