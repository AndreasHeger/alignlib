...
//-------------------------------------------------------------
void ImplPhyloMatrix::Swap( PhyloMatrixSize col_1, PhyloMatrixSize col_2 ) 
{
    // TODO !! to be implemented, not finished
    PhyloMatrixValue swap_temp;	// for swapping indices
    ...
    for (i = 0; i < mWidth; i++) {
	SWAP( mMatrix[getIndex(i, col_1)], mMatrix[getIndex(i, col_2)]);
	SWAP( mMatrix[getIndex(col_1, i)], mMatrix[getIndex(col_2, i)]);
  }
