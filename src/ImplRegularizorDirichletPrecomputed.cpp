...
ImplRegularizorDirichletPrecomputed::ImplRegularizorDirichletPrecomputed ( Count fade_cutoff ) : ImplRegularizorDirichlet( fade_cutoff ) {
...
*/
double ImplRegularizorDirichletPrecomputed::calculateBetaDifferences( TYPE_BETA_DIFFERENCES beta_differences, const Count * n, Count ntotal ) const { 
