...
namespace alignlib {
  ...
  /** This alignator object is initialized with an alignment. No
      ...
      is returned. You can use this for radar-like problems, where 
      you have a precalculated dot-matrix and you want to supply
      it to ALignatorDots.
      
      @author Andreas Heger
      @version $Id: ImplAlignatorDummy.h,v 1.2 2004/01/07 14:35:34 aheger Exp $
...
class ImplAlignatorDummy : public ImplAlignator {
 public:
    // constructors and desctructors

    /** default constructor */
    ImplAlignatorDummy  ( const Alignata * ali);
