...
ImplRegularizorDirichletHash::ImplRegularizorDirichletHash ( Count fade_cutoff ) : ImplRegularizorDirichlet( fade_cutoff ) {
}
...
/** This function encapsulates that part of the algorithm, that needs to access the lgamma-function. It
    ...
    This function uses the lgamma-function directly.
*/
double ImplRegularizorDirichletHash::calculateBetaDifferences( TYPE_BETA_DIFFERENCES beta_differences, const Count * n, Count ntotal ) const { 
