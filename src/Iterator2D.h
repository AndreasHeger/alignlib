...
namespace alignlib
{
  ...
  class Iterator2D
    ...
    public:
      ...
      virtual const_iterator row_begin ( Position col = 0 ) const = 0;
      virtual const_iterator row_end   ( Position col = 0 ) const = 0;      
      virtual const_iterator col_begin ( Position row = 0 ) const = 0;
      virtual const_iterator col_end   ( Position row = 0 ) const = 0;      

      /** return first/last residues in rows/columns */
      virtual Position row_front ( Position col = 0) const = 0;
      virtual Position row_back  ( Position col = 0) const = 0;
      virtual Position col_front ( Position row = 0) const = 0;
      virtual Position col_back  ( Position row = 0) const = 0;      

      /** return extreme coordinates. If no row/col is given, return maximum extension */
      virtual Position row_size( Position col = 0) const = 0;
      virtual Position col_size( Position row = 0) const = 0;
