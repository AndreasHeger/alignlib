...
{
	return HAlignator( new ImplAlignatorFragments( fragmentor, gop, gep, gop, gep));
}
...
ImplAlignatorFragments::ImplAlignatorFragments(
		...
		//----------------------------------------------------------------------------------------------------------
		HAlignator ImplAlignatorFragments::getClone() const 
		{
			return HAlignator( new ImplAlignatorFragments( *this ) );
		}
		...
		void ImplAlignatorFragments::performAlignment( 
				HAlignment & ali,
