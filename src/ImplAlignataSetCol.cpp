...
Position ImplAlignataSetCol::getRowFrom() const { return (mPairs.size() > 0) ? (*mPairs.begin())->mRow : 0; }
Position ImplAlignataSetCol::getColFrom() const { return (mPairs.size() > 0) ? (*mPairs.begin())->mCol : 0; }
Position ImplAlignataSetCol::getRowTo()   const { return (mPairs.size() > 0) ? (*mPairs.rbegin())->mRow : 0; }
Position ImplAlignataSetCol::getColTo()   const { return (mPairs.size() > 0) ? (*mPairs.rbegin())->mCol : 0; }
  
ResiduePAIR ImplAlignataSetCol::getFirstPair() const { return **(mPairs.begin()); }
ResiduePAIR ImplAlignataSetCol::getLastPair()  const { return **(mPairs.rbegin()); }
