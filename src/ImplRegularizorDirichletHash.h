/*
  ...
  $Id: ImplRegularizorDirichletHash.h,v 1.2 2004/01/07 14:35:36 aheger Exp $
...
#ifndef IMPL_REGULARIZOR_DIRICHLET_HASH_H
#define IMPL_REGULARIZOR_DIRICHLET_HASH_H 1
...
namespace alignlib {
	...
	@version $Id: ImplRegularizorDirichletHash.h,v 1.2 2004/01/07 14:35:36 aheger Exp $
	@short protocol class for sequence weighters
	
    */

class ImplRegularizorDirichletHash : public ImplRegularizorDirichlet {
 public:
    // constructors and desctructors

    /** default constructor */
    ImplRegularizorDirichletHash ( Count fade_cutoff );
    
    /** copy constructor */
    ImplRegularizorDirichletHash ( const ImplRegularizorDirichletHash &);

    /** destructor */
    virtual ~ImplRegularizorDirichletHash ();
...
#endif /* IMPL_REGULARIZOR_DIRICHLET_HASH_H */
