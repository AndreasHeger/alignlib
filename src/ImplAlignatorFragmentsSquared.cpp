...
{
  return new ImplAlignatorFragmentsSquared(  gop, gep, gop, gep, fragmentor );
}

//----------------------------------------------------------------------------------------------------------------------------------------
    /** constructors and destructors */
ImplAlignatorFragmentsSquared::ImplAlignatorFragmentsSquared( Score row_gop, Score row_gep, 
							      Score col_gop, Score col_gep,
							      Fragmentor * fragmentor) :
    ImplAlignatorFragments( row_gop, row_gep, col_gop, col_gep, fragmentor) {
}
