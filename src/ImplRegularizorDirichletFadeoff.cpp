/*
  ...
  $Id: ImplRegularizorDirichletFadeoff.cpp,v 1.2 2004/01/07 14:35:36 aheger Exp $
...
namespace alignlib {
    ...
    /** factory functions */
    Regularizor * makeRegularizorDirichlet() { return new ImplRegularizorDirichlet();}
...
extern const ImplRegularizorDirichlet DEFAULT_REGULARIZOR = ImplRegularizorDirichlet(); 
...
double ImplRegularizorDirichlet::calculateBetaDifferences( TYPE_BETA_DIFFERENCES beta_differences, const Count * n, Count ntotal ) const { 
	...
	for (j = 0; j < NCOMPONENTS; j++) {
	    ...
	    beta_differences[i][j] = difference;
...
*/      
void ImplRegularizorDirichlet::fillFrequencies( FrequencyColumn * frequencies, 
