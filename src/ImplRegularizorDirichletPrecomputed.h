/*
  ...
  $Id: ImplRegularizorDirichletPrecomputed.h,v 1.2 2004/01/07 14:35:36 aheger Exp $
...
#ifndef IMPL_REGULARIZOR_DIRICHLET_PRECOMPUTED_H
#define IMPL_REGULARIZOR_DIRICHLET_PRECOMPUTED_H 1
...
namespace alignlib {
	...
	@version $Id: ImplRegularizorDirichletPrecomputed.h,v 1.2 2004/01/07 14:35:36 aheger Exp $
	@short protocol class for sequence weighters
	
    */

class ImplRegularizorDirichletPrecomputed : public ImplRegularizorDirichlet {
 public:
    // constructors and desctructors

    /** default constructor */
    ImplRegularizorDirichletPrecomputed ( Count fade_cutoff );
    
    /** copy constructor */
    ImplRegularizorDirichletPrecomputed ( const ImplRegularizorDirichletPrecomputed &);

    /** destructor */
    virtual ~ImplRegularizorDirichletPrecomputed ();
