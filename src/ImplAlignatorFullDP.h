...
#ifndef IMPL_ALIGNATOR_FULLDP_H
#define IMPL_ALIGNATOR_FULLDP_H 1
...
/**
    ...
    @version $Id: ImplAlignatorFullDP.h,v 1.3 2004/03/19 18:23:41 aheger Exp $
*/
class ImplAlignatorFullDP : public ImplAlignator {

    typedef Score (ImplAlignatorFullDP::*MATCH_FUNCTION_POINTER)( Position, Position); 
 ...
 public:
    ...
    */
    ImplAlignatorFullDP(  const SubstitutionMatrix * subst_matrix ,
    ...
    /** copy constructor */
    ImplAlignatorFullDP( const ImplAlignatorFullDP & );

    /** destructor */
    virtual ~ImplAlignatorFullDP();
