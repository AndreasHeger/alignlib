...
struct AlignmentFormatDiagonals_wrapper : alignlib::AlignmentFormatDiagonals, bp::wrapper< alignlib::AlignmentFormatDiagonals > {
    ...
    virtual void fill( ::alignlib::HAlignment const & src, bool const reverse, ::alignlib::Position const row_from=-0x00000000000000001, ::alignlib::Position const row_to=-0x00000000000000001, ::alignlib::Position const col_from=-0x00000000000000001, ::alignlib::Position const col_to=-0x00000000000000001, ::alignlib::Diagonal const diagonal_from=std::numeric_limits<long int>::min(), ::alignlib::Diagonal const diagonal_to=std::numeric_limits<long int>::max() ) {
    ...
    void default_fill( ::alignlib::HAlignment const & src, bool const reverse, ::alignlib::Position const row_from=-0x00000000000000001, ::alignlib::Position const row_to=-0x00000000000000001, ::alignlib::Position const col_from=-0x00000000000000001, ::alignlib::Position const col_to=-0x00000000000000001, ::alignlib::Diagonal const diagonal_from=std::numeric_limits<long int>::min(), ::alignlib::Diagonal const diagonal_to=std::numeric_limits<long int>::max() ) {
