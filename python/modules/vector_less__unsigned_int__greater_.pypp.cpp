...
void register_vector_less__unsigned_int__greater__class(){
    ...
    { //::std::vector< unsigned int >
        typedef bp::class_< std::vector< unsigned int >, boost::noncopyable > vector_less__unsigned_int__greater__exposer_t;
        ...
        vector_less__unsigned_int__greater__exposer.def( bp::vector_indexing_suite< ::std::vector< unsigned int > >() );
    }
